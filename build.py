...
RENDER.peya=()=>{const PY=(DATA.peya||{})[PERIOD];const el=document.getElementById('sec-peya');
 ...
 html+='</div>';
 html+=note('PedidosYa · '+PY.rango+'' · Barrio Sur y FLIP con datos parciales (mes en curso). Es un subconjunto del total de la red — no se suma aparte. Independiente del selector de período.');
 el.innerHTML=html;
