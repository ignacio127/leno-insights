...
// ===========================================================================
const MP_CATS=['Efectivo','LENO+ (canal propio)','MercadoPago/QR','Tarjeta (PayWay)','Nave','PedidosYa','NCB/SID','Sin clasificar'];
const MP_PAL={'Efectivo':'#E2001A','LENO+ (canal propio)':'#8b5cf6','MercadoPago/QR':'#10b981','Tarjeta (PayWay)':'#2563eb','Nave':'#0ea5e9','PedidosYa':'#FA0050','NCB/SID':'#d97706','Sin clasificar':'#9aa1b2'};
